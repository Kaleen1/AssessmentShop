<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Meat.aspx.cs" Inherits="Template_Project.Page1" %>
            ...
            $("#form1").swipe(
                {
                    swipe: function (event, direction, distance, duration, fingerCount) {
                        if (direction == "left") {
                            window.location.href = "Dairy.aspx"
                        }
    ...
    <form id="form1" runat="server" style="height:100vh; width:100vw">
        ...
        <div class ="row">            
            <div class="col-sm-2 offset-sm-1"  >
                <asp:LinkButton ID="LnkBtnMeats" runat="server" OnClick="LnkBtnMeats_Click" Font-Bold="True">Meats</asp:LinkButton>            
            </div>
            <div class="col-sm-2">
