<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dairy.aspx.cs" Inherits="Template_Project.Page2" %>
...
<body>    
    <form id="form1" runat="server" style="height:100vh; width:100vw">
        ...
        <div class ="row">            
            ...
            <div class="col-sm-2">
                <asp:LinkButton ID="LnkBtnDairy" runat="server" OnClick="LnkBtnDairy_Click" Font-Bold="True">Dairy</asp:LinkButton>
            </div>
            <div class="col-sm-2">
